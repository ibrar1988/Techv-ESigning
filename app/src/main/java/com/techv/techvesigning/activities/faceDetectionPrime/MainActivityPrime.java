package com.techv.techvesigning.activities.faceDetectionPrime;
...
public class MainActivityPrime extends AppCompatActivity {
    ...
    private void createCameraSource() {
        ...
        detector.setProcessor(
                new MultiProcessor.Builder<>(new MainActivityPrime.GraphicFaceTrackerFactory())
                        .build());
    ...
    private class GraphicFaceTrackerFactory implements MultiProcessor.Factory<Face> {
        ...
        public Tracker<Face> create(Face face) {
            return new MainActivityPrime.GraphicFaceTracker(cameraOverlay);
        }
    }
